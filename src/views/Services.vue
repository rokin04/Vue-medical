              ...
              <v-container>
                <v-row>
                  <v-col cols="12" sm="6" md="4">
                    <v-text-field v-model="editedItem.officeCode" label="Office code"></v-text-field>
                  </v-col>
                  <v-col cols="12" sm="6" md="4">
                    <v-text-field v-model="editedItem.description" label="Description"></v-text-field>
                  </v-col>
                  <v-col cols="12" sm="6" md="4">
                    <v-text-field v-model="editedItem.billingCode" label="Billing code"></v-text-field>
                  </v-col>
                  <v-col cols="12" sm="6" md="4">
                    <v-text-field v-model="editedItem.baseCharge" label="Base charge"></v-text-field>
                  </v-col>
                </v-row>
              </v-container>
            </v-card-text>
    ...
    methods: {
      ...
      save () {
        if (this.editedIndex > -1) {
          ...
          this.services.push(this.editItem);
        }
        this.close()
      },
    },
